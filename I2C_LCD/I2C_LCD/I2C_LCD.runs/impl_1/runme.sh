...
HD_PWD='/home/spixy/Documents/College/EE316/EE316P3/EE316P3/I2C_LCD/I2C_LCD/I2C_LCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cora_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cora_wrapper.tcl -notrace
