...
HD_PWD='/home/spixy/Documents/College/EE316/EE316P3/EE316P3/master/master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CoraZ7.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CoraZ7.tcl -notrace
